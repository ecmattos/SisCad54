...
class PatrimonialRepositoryEloquent extends BaseRepository implements PatrimonialRepository
{
    ...
    public function allPatrimonialsByPatrimonialSectorId($id)
    {
        return $this->patrimonial
            ->wherePatrimonialSectorId($id)
            ->get();
    }

    public function allPatrimonialsByPatrimonialSubSectorId($id)
    {
        return $this->patrimonial
            ->wherePatrimonialSubSectorId($id)
            ->get();
    }
    ...
    public function searchPatrimonials()
    {
        ...
        return $this->patrimonial
            ...
            ->where(function($query) use ($srch_patrimonial_code, $srch_patrimonial_description, $srch_asset_accounting_account_id, $srch_patrimonial_serial, $srch_patrimonial_type_id, $srch_patrimonial_sub_type_id, $srch_patrimonial_brand_id, $srch_patrimonial_model_id, $srch_patrimonial_provider_id, $srch_patrimonial_management_unit_id, $srch_patrimonial_sector_id, $srch_patrimonial_sub_sector_id, $srch_patrimonial_status_id, $srch_patrimonial_status_date_start, $srch_patrimonial_status_date_end, $srch_patrimonial_invoice_date_start, $srch_patrimonial_invoice_date_end) 
            {
                ...
                {
                    $query->whereManagementUnitId($srch_patrimonial_management_unit_id);
                }
