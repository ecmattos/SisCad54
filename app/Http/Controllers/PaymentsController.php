...
class PaymentsController extends Controller
{
    ...
    public function import(Requests\PaymentImportRequest $request, MemberRepository $memberRepository)
    {
        ...
        {
            Session::flash('flash_message_warning', 'Não foi possível importar '.$row_counter_errors.' registros do total de '.($row_counter + $row_counter_errors).' para os Associados correspondentes as matrículas: '.$row_member_code_errors.'.');
        }
