...
class PatrimonialRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'affiliated_society_id'     => 'required',
            'patrimonial_sector_id'     => 'required',
            'patrimonial_sub_sector_id' => 'required',
            'patrimonial_status_id'     => 'required',
            'patrimonial_status_date'   => 'required|after:purchase_date|date_format:d/m/Y'
            //
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'affiliated_society_id.required'        => '<b>Filial</b> >> Preenchimento obrigatório.',
