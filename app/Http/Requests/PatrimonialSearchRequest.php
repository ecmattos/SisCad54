...
class PatrimonialSearchRequest extends Request
{
    ...
    public function rules()
    {
        ...
        return [
            'srch_patrimonial_code' => 'required_without_all:srch_patrimonial_description,srch_patrimonial_type_id,srch_patrimonial_sub_type_id,srch_patrimonial_brand_id,srch_patrimonial_model_id,srch_patrimonial_serial,srch_patrimonial_purchase_process,srch_asset_accounting_account_id,srch_patrimonial_provider_id,srch_patrimonial_purchase_invoice,srch_patrimonial_invoice_date_start,srch_patrimonial_invoice_date_end,srch_patrimonial_status_date_start,srch_patrimonial_status_date_end,srch_patrimonial_management_unit_id,srch_patrimonial_sector_id,srch_patrimonial_sub_sector_id,srch_patrimonial_status_id',
