...
@section('content')
	...
	<div class="page-header text-primary">
          ...
          Administração - Modelos de Ativos: Consulta
          <div class="btn-group btn-group-sm pull-right">
            ...
            <a href="{!! route('patrimonial_models.edit', ['id' => $patrimonial_brand->id]) !!}" type="button" class="round round-sm hollow blue" rel="tooltip" title="Editar"><i class="fa fa-edit"></i></a>
            ...
            <a href="{!! route('patrimonial_models') !!}" type="button" class="round round-sm hollow red" rel="tooltip" title="Excluir"><i class="fa fa-trash-o"></i></a>
          </div>
      	</h4>
      	<hr class="hr-warning" />
  	</div>
    	...
    	<div class="col-sm-8">
      		<div class="table-responsive">
      			<table class="table table-bordered table-striped">
          			<thead>
           				<th class="text-center" colspan="2"><h3><b>{{ $patrimonial_model->code }} - {{ $patrimonial_model->description }}</b></h3></th>
          			</thead>
          			<tbody>
          				<tr>
