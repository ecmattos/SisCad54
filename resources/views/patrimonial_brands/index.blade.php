...
@section('content')
	<ol class="breadcrumb">
  		...
  		<li class="breadcrumb-item"><b>Marcas</b></li>
	</ol>

	<div class="table-responsive">
		<table class="table table-bordered table-striped" id="table_patrimonial_brands" data-toggle="table" data-toolbar="#filter-bar" data-show-toggle="false" data-search="false" data-show-filter="true" data-show-columns="true" data-show-export="true" data-pagination="true" data-click-to-select="true" data-page-list="[10, 20, 50, 100, All]" data-toolbar="#filter-bar"> 
			<thead>
...
@section('js_scripts')
	<script type="text/javascript">
	  	$('#table_patrimonial_brands').bootstrapTable();
	</script>
@endsection