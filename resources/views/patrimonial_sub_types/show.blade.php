...
@section('content')
	...
	<div class="page-header text-primary">
          ...
          Administração - Sub-tipos de Ativos: Consulta
          <div class="btn-group btn-group-sm pull-right">
            ...
            <a href="{!! route('patrimonial_sub_types.edit', ['id' => $patrimonial_sub_type->id]) !!}" type="button" class="round round-sm hollow blue" rel="tooltip" title="Editar"><i class="fa fa-edit"></i></a>
            ...
            <a href="{!! route('patrimonial_sub_types') !!}" type="button" class="round round-sm hollow red" rel="tooltip" title="Excluir"><i class="fa fa-trash-o"></i></a>
          </div>
      	</h4>
      	<hr class="hr-warning" />
  	</div>
