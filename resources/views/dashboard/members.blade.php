...
@section('content')
	...
	<ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><b>ASSOCIADOS {{ $member_status->description }}S</b></li>

        <div class="row pull-right">
            <a href="{!! route('dashboard.pc_members', ['pc_member_status_id' => 2]) !!}" class="btn btn-xs btn-primary btn-success">ATIVOS</span></a>
    
            <a href="{!! route('dashboard.pc_members', ['pc_member_status_id' => 1]) !!}" class="btn btn-xs btn-primary btn-warning">INATIVOS</a>
    
            <a href="{!! route('dashboard.pc_members', ['pc_member_status_id' => 3]) !!}" class="btn btn-xs btn-primary btn-info">NÃO SÓCIOS</a>
            |
